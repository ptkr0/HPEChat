      ...
      <form onSubmit={handleSubmit(submitHandler)} className="flex flex-col">
        <div className="relative">
          ...
          <div className="absolute right-3 top-1/2 -translate-y-1/2 flex items-center gap-1 z-10">
            <Button type="button" size="icon" variant="outline" className="rounded-full h-8 w-8">
            ...
            <Button
              type="submit"
              size="icon"
              className={`rounded-full h-8 w-8 ${!isSubmitting && isValid} ? "text-muted-foreground bg-transparent hover:bg-transparent" : "bg-emerald-500 hover:bg-emerald-600 text-white"}`}
